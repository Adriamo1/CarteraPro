// js/widgets/widget-ranking-rentabilidad.js
import { db } from '../db.js';
import { formatPercent } from '../core.js';

// Ranking de rentabilidad por activo
export async function render(container, privacy = false, { topN = 5 } = {}) {
  const activos = await db.activos.toArray();

  // Calcula rentabilidad aproximada para activos con precioCompra y valorActual
